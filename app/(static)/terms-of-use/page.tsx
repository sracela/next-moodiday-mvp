...
export default function Terms() {
  return (
    <div className="flex flex-col w-full text-center termsOfUse mt-20">
      ...
      <p>Terms of Use</p>
      <p>Effective date: November 14, 2022</p>
      <p>
        Welcome to Moodi Day. Please read on to learn the rules and restrictions
      ...
      <p>
        ...
        MD DIstribution LLC dba Moodi Day (“Moodi Day,” “we” and “us”). You must
        agree to and accept all of the Terms, or you don’t have the right to use
        the Services in any manner. Your using the Services in any way means
      ...
      <p>
        Your use of or participation in certain Services may be subject to
        additional policies, rules and/or conditions (“Additional Terms”) which
        are incorporated herein by reference, and you understand and agree that
        by using or participating in any such Services, you agree to also comply
        with these Additional Terms.
      </p>
      <p>
        <b>Will these Terms ever change?</b>
      </p>
      <p>
        ...
        the Terms at any time, but if we do, we will place a notice on the
        moodiday.com website, send you an email, and/or notify you by some other
        means.
      </p>
      <p>
      ...
      <p>
        <b>What about my privacy?</b>
      </p>
      <p>
        Moodi Day takes the privacy of its users very seriously. For the current
        Moodi Day Privacy Policy, please click here.
      </p>
      <p>
        ...
        information from children under 13; if you are a child under 13, please
        do not attempt to register for or otherwise use the Services or send us
        any personal information. If we learn we have collected personal
        information from a child under 13, we will delete that information as
        quickly as possible. If you believe that a child under 13 may have
        provided us personal information, please contact us at{" "}
        <a href="mailto:info@moodiday.com" className="pLink">
          info@moodiday.com
        </a>
        .
      </p>
      <p>
        By providing us with your wireless phone number, you confirm that you
        want Moodi Day to send you information we think may be of interest to
        you, which may include Moodi Day using automated dialing technology to
        text you at the wireless number you provided.
      </p>
      <p>
        <b>What are the basics of using Moodi Day?</b>
      </p>
      <p>
        In order to use the Services you will be required to complete a
        registration survey. You promise to provide us with accurate, complete,
        and updated registration information about yourself. You may not use
        another person’s name with the intent to impersonate that person. You
      ...
      <p>
        ...
        permission to use the Services and have gotten your parent or guardian
        to agree to these Terms on your behalf). If you’re agreeing to these
        Terms on behalf of an organization or entity, you represent and warrant
        that you are authorized to agree to these Terms on that organization or
      ...
      <p>
        ...
        behalf of or for the benefit of any third party, and only in a manner
        that complies with all laws that apply to you. If your use of the
        Services is prohibited by applicable laws, then you aren’t authorized to
        use the Services. We can’t and won’t be responsible for your using the
        Services in a way that breaks the law.
      </p>
      <p>
        <b>Consent to receive periodic messages</b>
      </p>
      <p>
        As part of the Services, you may receive communications through the
        Services, including messages that Moodi Day sends you (for example, via
        SMS). When signing up for the Services, you will receive a welcome
        message and instructions on how to stop receiving messages. BY SIGNING
        UP FOR THE SERVICES, YOU AGREE TO RECEIVE COMMUNICATIONS FROM MOODI DAY,
        AND YOU REPRESENT AND WARRANT THAT EACH PERSON YOU REGISTER FOR THE
        SERVICES OR FOR WHOM YOU PROVIDE A WIRELESS PHONE NUMBER HAS CONSENTED
        TO RECEIVE COMMUNICATIONS FROM MOODI DAY. You agree to indemnify and
        hold Moodi Day harmless from and against any and all claims,
        liabilities, damages (actual and consequential), losses and expenses
        (including attorneys’ fees) arising from or in any way related to your
      ...
      <ul>
        <li>
          ...
          other rights of anyone else (including Moodi Day);
        </li>
        <li>
          ...
          reasonably intended by Moodi Day;
        </li>
        <li>
          {" "}
          (c) Is dangerous, harmful, fraudulent, deceptive, misleading, false,
          inaccurate, threatening, harassing, defamatory, obscene, or otherwise
          objectionable;
        </li>
        <li>(d) Exploits people in a sexual or violent manner;</li>
        <li>
          (e) Attempts, in any manner, to obtain the password, account, or other
          security information from any other{" "}
        </li>
        <li>
          {" "}
        ...
        <p>
          Furthermore, if you are a candidate, you shall not (directly or
          indirectly):
        </p>
      </ul>
      <ul>
        <li>(a) Complete an assessment on behalf of another party; or</li>
        <li>
          (b) Post or submit any incomplete, false or inaccurate biographical
          information or information which is not your own.
        </li>
      </ul>
      <p>
        Furthermore, if you are an employer, you shall not (directly or
        indirectly):
      </p>
      <ul>
        <li>
          (a) Provide opportunities, content or information in a manner that
          does not comply with applicable local, national and international
          laws, including but not limited to laws relating to labor and
          employment, equal employment opportunity and employment eligibility
          requirements, data privacy, data access and use, and intellectual
          property;
        </li>
        <li>
          (b) Promote opportunities that include any screening requirement or
          criterion in connection with a job posting where such requirement or
          criterion is not an actual and legal requirement of the posted job;
        </li>
        <li>
          {" "}
          (c) Promote any franchise, pyramid scheme, “club membership”,
          distributorship, multi-level marketing opportunity, or sales
          representative agency arrangement;
        </li>
        <li>
          (d) Promote any business opportunity that requires an upfront or
          periodic payment or requires recruitment of other members,
          sub-distributors or sub-agents;
        </li>
        <li>
          (e) Promote any business opportunity that pays commission only unless
          the posting clearly states that the available job pays commission only
          and clearly describes the product or service that the job seeker would
          be selling;
        </li>
        <li>
          (f) Advertise sexual services or seek employees for jobs of a sexual
          nature;
        </li>
        <li>
          (g) Request the use of human body parts or the donation of human
          parts, including, without limitation, reproductive services such as
          egg donation and surrogacy
        </li>
        <li>
          (h) Endorse a particular political party, political agenda, political
          position or issue;
        </li>
        <li>(i) Promote a particular religion;</li>
        <li>
          (j) Promote jobs located in countries subject to economic sanctions of
          the United States Government;
        </li>
        <li>
          (k) Except where allowed by applicable law, promote opportunities
          which require the applicant to provide information relating to his/her
          (i) racial or ethnic origin, (ii) political beliefs, (iii)
          philosophical or religious beliefs, (iv) membership of a trade union,
          (v) physical or mental health, (vi) sexual life, (vii) the commission
          of criminal offences or proceedings, or (viii) age.
        </li>
      </ul>
      <p>
        A violation of any of the foregoing is grounds for termination of your
        right to use or access the Services. Moodi Day also reserves the right
        ...
        safety of us, our users and the public. Moodi Day may, but is not
        obligated to, make an independent investigation to ensure full
        compliance with these Terms. If we determine, in our sole discretion,
        that any representation or warranty made by you pursuant to these Terms
        is in any way false, incomplete, or inaccurate, we may, at any time,
        reject, remove, or suspend or delay your use or access to the Services,
        in whole or in part.
      </p>
      <p>
        <b>What are my rights in the Services?</b>
      </p>
      <p>
        The materials displayed or performed or available on or through the
        Services, including, but not limited to, assessments, reports, business
        descriptions, biographies, user demographics, and any other information,
        text, graphics, data, articles, photos, images, illustrations, User
        Submissions, and so forth (all of the foregoing, the “Content”) are
        ...
        and restrictions contained in any Content you access through the
        Services, and you won’t use, copy, reproduce, modify, translate,
        publish, broadcast, transmit, distribute, perform, upload, display,
        license, sell, commercialize or otherwise exploit for any purpose any
      ...
      <p>
        You understand that Moodi Day owns the Services. You won’t modify,
      ...
      <p>
        <b>Do I have to grant any licenses to Moodi Day or to other users?</b>
      </p>
      <p>
      ...
      <p>
        For all User Submissions, you hereby grant Moodi Day a license to
        translate, modify (for technical purposes, for example, making sure your
        content is viewable on a mobile device as well as a computer) and
      ...
      <p>
        ...
        Submission”), then you grant Moodi Day the licenses above, as well as a
        ...
        Moodi Day users and providing the Services necessary to do so, as well
        ...
        in connection with Moodi Day’s business for any purpose. Also, you grant
      ...
      <p>
        Finally, you understand and agree that Moodi Day, in performing the
      ...
      <p>
        ...
        as it relates to online service providers, like Moodi Day, being asked
        to remove material that allegedly violates someone’s copyright. We
        respect others’ intellectual property rights, and we reserve the right
        to delete or disable Content alleged to be infringing, and to terminate
        the accounts of repeat alleged{" "}
      </p>
      <p>
        infringers. In accordance with the DMCA, we’ve adopted the policy below
        toward copyright infringement. To learn more about the DMCA, see link to{" "}
        <a
      ...
      <p>
        ...
        infringement containing the following information to the Moodi Day
      ...
      <ul>
        ...
        <li>
          ...
          sufficient detail so that Moodi Day is capable of finding and
      ...
      <ul>
        ...
        <li>
          {" "}
          (b) notify the content provider who is accused of infringement that we
          have removed or disabled access to the applicable material;
        </li>
        <li>
          (c) terminate such content provider’s access to the Services if he or
      ...
      <ul>
        <li>(a) A physical or electronic signature of the content provider;</li>
        <li>
        ...
        <li>
          (c) A statement that the content provider has a good faith belief that
        ...
        <li>
          ...
          for any judicial district in which Moodi Day is located, and that such
          ...
          is received by the Designated Agent, Moodi Day may, in its discretion,
          send a copy of the counter-notice to the original complaining party
          informing that person that Moodi Day may replace the removed material
          ...
          after receipt of the counter-notice, at Moodi Day’s discretion.
        </li>
      </ul>
      <p>
        <b>
          Please contact Moodi Day’s Designated Agent at the following address:{" "}
          <a href="mailto:info@moodiday.com" className="pLink">
            info@moodiday.com
          </a>
          .
      ...
      <p>
        ...
        services that are not owned or controlled by Moodi Day. When you access
        third party websites or use third party services, you accept that there
        are risks in doing so, and that Moodi Day is not responsible for such
      ...
      <p>
        Moodi Day has no control over, and assumes no responsibility for, the
        ...
        interact with through the Services, including third party employers. In
        addition, Moodi Day will not and cannot monitor, verify, censor or edit
        the content of any third-party site or service. By using the Services,
        you release and hold us harmless from any and all liability arising from
      ...
      <p>
        ...
        Moodi Day shall not be responsible or liable for any loss or damage of
        any sort incurred as the result of any such dealings.
      </p>
      <p>
        If there is a dispute between participants on this site, or between
        users and any third party, you agree that Moodi Day is under no
        obligation to become involved. In the event that you have a dispute with
        one or more other users, you release Moodi Day, its directors, officers,
      ...
      <p>
        <b>Will Moodi Day ever change the Services?</b>
      </p>
      <p>
      ...
      <p>
        <b>Do the Services cost anything?</b>
      </p>
      <p>
        The Services may be free or we may charge a fee for using the Services.
        If you are using a free version of the Services, we will notify you
        ...
        for such Services. Note that if you elect to receive text messages
        through the Services, data and message rates may apply. Any and all such
        charges, fees or costs are your sole responsibility. You should consult
        with your wireless carrier to determine what rates, charges, fees or
        costs may apply to your use of the Services.
      </p>
      <ul>
        <li>
          (a) <b>Paid Services.</b> Certain of our Services may be subject to
          payments now or in the future (the “Paid Services”). Please note that
          any payment terms presented to you in the process of using or signing
          up for a Paid Service are deemed part of these Terms.
        </li>
        <li>
          (b) <b>Billing.</b> We use a third-party payment processor (the
          “Payment Processor”) to bill you through a payment account linked to
          your account on the Services (your “Billing Account”) for use of the
          ...
          addition to these Terms. We are not responsible for error by the
          Payment Processor. By choosing to use Paid Services, you agree to pay
        ...
        <li>
          (c) <b>Payment Method.</b> The terms of your payment will be based on
          your Payment Method and may be determined by agreements between you
          and the financial institution, credit card issuer or other provider of
          your chosen Payment Method. If we, through the Payment Processor, do
          not receive payment from you, you agree to pay all amounts due on your
          Billing Account upon demand.
        </li>
        <li>
          (d) <b>Recurring Billing.</b> Some of the Paid Services may consist of
          an initial period, for which there is a one-time charge, followed by
          recurring period charges as agreed to by you. By choosing a recurring
          ...
          YOU PROVIDE PRIOR NOTICE (RECEIPT OF WHICH IS CONFIRMED BY US) THAT
          ...
          PAYMENT METHOD, PLEASE CONTACT US AT info@moodiday.com.
        </li>
        <li>
          (e) <b>Current Information Required.</b>YOU MUST PROVIDE CURRENT,
          COMPLETE AND ACCURATE INFORMATION FOR YOUR BILLING ACCOUNT. YOU MUST
          PROMPTLY UPDATE ALL INFORMATION TO KEEP YOUR BILLING ACCOUNT CURRENT,
          COMPLETE AND ACCURATE (SUCH AS A CHANGE IN BILLING ADDRESS, CREDIT
          CARD NUMBER, OR CREDIT CARD EXPIRATION DATE), AND YOU MUST PROMPTLY
          NOTIFY US OR OUR PAYMENT PROCESSOR IF YOUR PAYMENT METHOD IS CANCELED
          (E.G., FOR LOSS OR THEFT) OR IF YOU BECOME AWARE OF A POTENTIAL BREACH
          OF SECURITY, SUCH AS THE UNAUTHORIZED DISCLOSURE OR USE OF YOUR USER
          NAME OR PASSWORD. CHANGES TO SUCH INFORMATION CAN BE MADE BY
          CONTACTING YOUR ACCOUNT MANAGER AT info@moodiday.com. IF YOU FAIL TO
        ...
        <li>
          (f) <b>Change in Amount Authorized.</b> If the amount to be charged to
          ...
          taxes), you have the right to receive, and we shall provide, notice of
          ...
          or more aggregate charges during or at the end of each billing cycle.
        </li>
        <li>
          (g) <b>Auto-Renewal for Paid Services.</b> Unless you opt out of
          auto-renewal, which can be done by contacting us at info@moodiday.com,
          ...
          time, please contact us at info@moodiday.com. If you terminate a Paid
          Service, you may use your subscription until the end of your
          ...
          then-current subscription period. If you do not want to continue to be
          charged on a recurring monthly basis, you must cancel the applicable
          Paid Service BY CONTACTING US AT info@mooodiday.com or terminate your
          Moodi Day account before the end of the recurring TERM. Paid Services
          cannot be terminated before the end of the period for which you have
          already paid, and except as expressly provided in these terms, Moodi
          Day will not refund any fees that you have already paid.
        </li>
        <li>
          (h)<b> Reaffirmation of Authorization. </b>Your non-termination or
          continued use of a Paid Service reaffirms that we are authorized to
          charge your Payment Method for that Paid Service. We may submit those
          charges for payment and you will be responsible for such charges. This
          does not waive our right to seek payment directly from you. Your
          charges may be payable in advance, in arrears, per usage, or as
          otherwise described when you initially selected to use the Paid
          Service. Free Trials and Other Promotions. Any free trial or other
          ...
          before the end of the trial period in order to avoid being charged for
          that Paid Service.
        </li>
      </ul>
      <p>
        <b>What if I want to stop using the Services?</b>
      </p>
      <p>
        You’re free to do that at any time, by contacting us at
        info@moodiday.com; please refer to our Privacy Policy, as well as the
        licenses above, to understand how we treat information you provide to us
        after you have stopped using our Services. Moodi Day is also free to
        ...
        these Terms. Moodi Day has the sole right to decide whether you are in
      ...
      <p>
        ...
        with your account, including assessments, reports, questionnaires, and
        job listings, so keep that in mind before you decide to terminate your
        account. We will try to provide advance notice to you prior to our
        ...
        or security, or otherwise harmful to the rights or property of Moodi
        Day.
      </p>
      <p>
      ...
      <ul>
        <li>
          {" "}
          (a) Moodi Day provides a platform for individuals to network for
          professional purposes and Moodi Day does not screen or censor User
          Submissions on the Services. Moodi Day does not take part in, nor is
          Moodi Day in any way responsible for, any interactions between users
          of the Services, except to the extent necessary to maintain our
          Services. Any interaction between you and any other individual or
          entity through our Services or arising out of your use of our
          Services, including any interactions between you and employers (in the
          case of job seekers), and you and job seekers (in the case of
          employers), is solely between you and that other individual or entity.
          Moodi Day is not responsible for User Submissions, the quality, safety
          or legality of the jobs or opportunities provided, the truth or
          accuracy of the listings or communications, the ability of employers
          to offer job opportunities to job seekers or the ability of job
          seekers to fill job openings and Moodi Day makes no representations
          about any jobs, opportunities or User Submissions on the Services.
          Moodi Day disclaims any responsibility for any interactions between
          job seekers and employers. For avoidance of doubt, Moodi Day disclaims
          any responsibility for any services acquired or made available through
          our Services, even if Moodi Day investigates or attempts to verify any
          information in connection therewith. You agree that you must evaluate
          and bear all risks associated with the use of our Services and
          Content.
        </li>
        <li>
          (b) Note that there are risks, including but not limited to the risk
          of physical harm, of dealing with strangers, underage persons or
          people acting under false pretenses. You assume all risks associated
          with dealing with other users with whom you come in contact through
          the Services. By its very nature other people’s information may be
          ...
          sense when using the Services.
        </li>
        <li>
          (c) We have no special relationship with or fiduciary duty to you. You
          acknowledge that Moodi Day has no duty to take any action regarding:
          <br />
          o i. which users gain access to the Services;
          <br />
          o ii. what Content you access via the Services; or
          <br />o iii. how you may interpret or use the Content.
        </li>
        <li>
          (d) You release us from all liability for you having acquired or not
        ...
        <li>
          (e) THE SERVICES AND CONTENT ARE PROVIDED “AS IS”, “AS AVAILABLE” AND
          WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING, BUT NOT
          LIMITED TO, THE IMPLIED WARRANTIES OF TITLE, NON-INFRINGEMENT,
          MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE, AND ANY
          WARRANTIES IMPLIED BY ANY COURSE OF PERFORMANCE OR USAGE OF TRADE, ALL
          OF WHICH ARE EXPRESSLY DISCLAIMED. WE, AND OUR DIRECTORS, EMPLOYEES,
          CONSULTANTS, REPRESENTATIVES, AGENTS, SUPPLIERS, LICENSORS, PARTNERS
          AND CONTENT PROVIDERS (THE “MOODI DAY PARTIES”) DO NOT WARRANT THAT:
          <br />
          o (I) THE SERVICES WILL BE SECURE OR AVAILABLE AT ANY PARTICULAR TIME
          OR LOCATION;
          <br />
          o (II) ANY DEFECTS OR ERRORS WILL BE CORRECTED;
          <br />
          o (III) ANY CONTENT OR SOFTWARE AVAILABLE AT OR THROUGH THE SERVICES
          IS FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS; OR
          <br />o (IV) THE RESULTS OF USING THE SERVICES WILL MEET YOUR
          ...
          SHALL ANY OF THE MOODI DAY PARTIES BE LIABLE TO YOU OR TO ANY OTHER
          PERSON FOR
        </li>
        <li>
          ...
          OF RESULTS, OR COMPUTER FAILURE OR MALFUNCTION, OR
        </li>
        <li>
          (B) ANY AMOUNT, IN THE AGGREGATE, IN EXCESS OF THE GREATER OF (I)
          ONE-HUNDRED ($100) DOLLARS OR (II) THE AMOUNTS PAID AND/OR PAYABLE BY
          YOU IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD
          PRECEDING THIS APPLICABLE CLAIM, OR
        </li>
        <li>
          (C) ANY MATTER BEYOND OUR REASONABLE CONTROL. SOME STATES DO NOT ALLOW
          THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES, SO THE ABOVE
          LIMITATION AND EXCLUSIONS MAY NOT APPLY TO YOU. Indemnity. You agree
          to indemnify and hold the Moodi Day Parties harmless from and against
          ...
          way related to any third-party claims relating to
        </li>
        <li>
          (a) your use of the Services (including any actions taken by a third
          party using your account), and
        </li>
        <li>
          ...
          or otherwise) without Moodi Day’s prior written consent. We may
          transfer, assign, or delegate these Terms and our rights and
          obligations without consent.
        </li>
        <li>
          <i>Choice of Law.</i> These Terms are governed by and will be
          construed under the Federal Arbitration Act, applicable federal law,
          and the laws of the State of New Jersey, without regard to the
      ...
      <p>
        ...
        claims with Moodi Day and limits the manner in which you can seek relief
        from Moodi Day. Both you and Moodi Day acknowledge and agree that for
        the purposes of any dispute arising out of or relating to the subject
        matter of these Terms, Moodi Day’s officers, directors, employees and
      ...
      <p>
        (a) Arbitration Rules; Applicability of Arbitration Agreement. Any
        dispute arising out of or relating to the subject matter of these Terms
        shall be finally settled by binding arbitration in New York, New York.
        The arbitration will proceed in the English language, in accordance with
        the JAMS Streamlined Arbitration Rules and Procedures (the “Rules”) then
        ...
        relief at any time, from any court of competent jurisdiction.
      </p>
      <p>
        <i>(b) Costs of Arbitration.</i> The Rules will govern payment of all
        arbitration fees. Moodi Day will pay all arbitration fees for claims
        less than ten thousand ($10,000) dollars. Moodi Day will not seek its
        attorneys’ fees and costs in arbitration unless the arbitrator
        determines that your claim is frivolous.
      </p>
      <p>
        <i>(c) Small Claims Court. </i> Furthermore, either you or Moodi Day may
        assert claims, if they qualify, in small claims court in New York, New
        York or any United States county where you live or work.
      </p>
      <p>
        <i>(d) Waiver of Jury Trial. </i> YOU AND MOODI DAY WAIVE ANY
        CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN
        FRONT OF A JUDGE OR JURY. You and Moodi Day are instead choosing to have
        claims and disputes resolved by arbitration. Arbitration procedures are
        typically more limited, more efficient, and less costly than rules
        applicable in court and are subject to very limited review by a court.
        In any litigation between you and Moodi Day over whether to vacate or
        enforce an arbitration award, YOU AND MOODI DAY WAIVE ALL RIGHTS TO A
        JURY TRIAL, and elect instead to have the dispute be resolved by a
        judge.
      </p>
      <p>
        <i>(e) Waiver of Class or Consolidated Actions.</i> ALL CLAIMS AND
        ...
        USER. If however, this waiver of class or consolidated actions is deemed
        invalid or unenforceable, neither you nor Moodi Day is entitled to
        arbitration; instead all claims and disputes will be resolved in a court
        as set forth in (g) below.
      </p>
      <p>
        <i>(f) Opt-out.</i> You have the right to opt out of the provisions of
        this Section by sending written notice of your decision to opt out to
        the following address: Moodi Day, 8 Lombardy Street #40822, Newark, New
        Jersey 07102, postmarked within 30 days of first accepting these Terms.
        You must include (i) your name and residence address; (ii) the email
        address and/or telephone number associated with your account; and (iii)
        a clear statement that you want to opt out of these Terms’ arbitration
        agreement.
      </p>
      <p>
        <i>(g) Exclusive Venue. </i> If you send the opt-out notice in (f),
        and/or in any circumstances where the foregoing arbitration agreement
        permits either you or Moodi Day to litigate any dispute arising out of
        or relating to the subject matter of these Terms in court, then the
        foregoing arbitration agreement will not apply to either party and both
        you and Moodi Day agree that any judicial proceeding (other than small
        claims actions) will be brought in the state or federal courts located
        in the State of New Jersey.
      </p>
      <p>
        <i>(h) Severability. </i> If the prohibition against class actions and
        other claims brought on behalf of third parties contained above is found
        to be unenforceable, then all of the preceding language in this
        Arbitration section will be null and void. This arbitration agreement
        will survive the termination of your relationship with Moodi Day.
      </p>
      <p>
        <i>Miscellaneous.</i> You will be responsible for paying, withholding,
        ...
        Services, provided that Moodi Day may, in its sole discretion, do any of
        the foregoing on your behalf or for itself as it sees fit. The failure
        of either you or us to exercise, in any way, any right herein shall not
        ...
        You and Moodi Day agree that these Terms are the complete and exclusive
        statement of the mutual understanding between you and Moodi Day, and
        ...
        are not an employee, agent, partner, or joint venture of Moodi Day, and
        you do not have any authority of any kind to bind Moodi Day in any
        respect whatsoever.
      </p>
      <p>
        You and Moodi Day agree there are no third party beneficiaries intended
        under these Terms.
      </p>
      <p>Last Edited on 2022-14-11</p>
    </div>
  );
}
